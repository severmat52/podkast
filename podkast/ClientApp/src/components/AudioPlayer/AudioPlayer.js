...
class AudioPlayer extends Component{
        ...
        return(
            ...
            <div id='audio-player-grid'>
               <div className='podcast-player-controls-grid'>
                ...
                <div id='audioSlider'>
                    <label>{this.getFormattedMinutesAndSeconds(this.getCurrentTime())}</label>
                    <input type='range'
    ...
    getCurrentTime(){
        return this.hasAudio()
            ? this.props.audioPlayer.audio.currentTime
            : 0;
    }
    ...
    getCurrentDuration(){
        return this.hasAudio()
            ? this.getFormattedMinutesAndSeconds(this.props.audioPlayer.audio.duration)
            : 0;
    }
